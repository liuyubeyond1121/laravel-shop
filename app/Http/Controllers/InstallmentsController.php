...
class InstallmentsController extends Controller
{
    ...
    public function payByAlipay(Installment $installment)
    {
        ...
        $config['alipay']['default']['return_url'] = route('installments.alipay.return');
...
//            ]
    ...
    public function payByWechat(Installment $installment)
    {
        ...
        $config = config('pay');
        $config['wechat']['default']['notify_url'] = ngrok_url('installments.wechat.notify');
        $wechatOrder = Pay::wechat($config)->scan([
            'out_trade_no' => $installment->no.'_'.$nextItem->sequence,
